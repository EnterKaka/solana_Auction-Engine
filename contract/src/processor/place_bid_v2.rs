...
use crate::{
    ...
    utils::{
        ...
        TokenTransferParams,spl_token_transfer_2,TokenTransferParams_2,
    },
    EXTENDED, PREFIX,
};
...
pub fn place_bid_v2<'r, 'b: 'r>(
    ...
    let mut update_price = args.amount.saturating_sub(bid_price);
    // if let Some(instant_sale_price) = auction_extended.instant_sale_price {
    //     if real_amount > instant_sale_price {
