...
program_id=PublicKey("E9JncjXZmTeMaWPrQhfr4NVpfJmpcsqKCYqC4zQPcC5R")
...
for strategy in strategies:	
	...
	for action in strategy["actions"]:
		auction_extended=instruction.get_auction_v3_extended_data(
			conn=client,
			program_id=program_id,
			resource=resource
			)
